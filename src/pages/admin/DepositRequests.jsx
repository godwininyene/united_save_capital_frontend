      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="px-6 py-5 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h2 className="text-lg font-semibold text-gray-800">Deposit Requests</h2>
        ...
        {successMessage && (
          <div className="mx-6 mt-4 p-4 bg-green-50 border-l-4 border-green-500 rounded">
            <div className="flex">
              <div className="flex-shrink-0">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">{stats.totalDeposits}</h3>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4 hover:shadow-md transition-shadow">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-800">{stats.pendingDeposits}</h3>
                </div>
                <div className="p-3 rounded-lg bg-yellow-100 text-yellow-500">
                  ...
                  <tr key={index} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-500">{deposit.depositType}</span>
                      </div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">{deposit.account || 'N/A'}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <td colSpan="7" className="px-6 py-4 text-center">
                    {fetched ? (
                      <EmptyState 
                        ...
                        icon={<FiCreditCard className="text-gray-400 text-4xl" />}
                      />
                    ) : null}
                  </td>
                </tr>
          ...
          <div className="space-y-4 p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="font-medium">{selectedDeposit.reference}</p>
              </div>
              <div>
            ...
            <div className="border-t border-gray-200 pt-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-medium text-gray-900">{selectedDeposit.user?.fullname || 'N/A'}</p>
                  <div className="text-sm text-gray-500">
