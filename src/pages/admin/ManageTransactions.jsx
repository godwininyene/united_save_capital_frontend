      ...
      <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-slate-600">
        <table className="min-w-full divide-y divide-gray-200 dark:divide-slate-600">
          <thead className="bg-gray-50 dark:bg-slate-700">
            <tr>
              <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-1/5">Transaction</th>
              <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-1/5">User</th>
              <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-1/5">Amount</th>
              <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-1/5">Date</th>
              <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-1/5">Status</th>
              <th className="px-3 py-2 text-right text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider w-1/5">Actions</th>
            </tr>
          </thead>
          <tbody className="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-600">
            {!fetched ? (
              ...
              filteredTransactions.map(transaction => (
                <tr key={transaction._id} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
              ...
              <tr>
                <td colSpan={6} className="px-6 py-4">
                  <EmptyState 
                    ...
                    icon={<FiDollarSign className="text-gray-400 dark:text-gray-500 text-4xl" />}
                  />
                </td>
              </tr>
            )}
          ...
          <div className="space-y-4 p-6">
            ...
            <div className="border-t border-gray-200 dark:border-slate-600 pt-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white">{selectedTransaction.user?.fullname || 'N/A'}</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400">{selectedTransaction.user?.email || 'N/A'}</p>
                </div>
              </div>
            </div>
