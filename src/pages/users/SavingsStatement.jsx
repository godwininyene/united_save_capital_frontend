...
const SavingsStatement = () => {
  ...
  const handleDownloadFullStatement = () => {
    console.log("Downloading full savings statement");
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md overflow-hidden">
      <div className="p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-gray-800 dark:text-slate-100">Savings Statement</h1>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-500 dark:text-slate-400 mt-1">You have no savings account transactions yet</p>
          </div>
        ) : (
