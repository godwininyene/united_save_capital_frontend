...
const Investment = () => {
  return (
    <div className="bg-white rounded-xl shadow-md overflow-hidden">
      <div className="p-6">
        <div className="mb-8">
          <h1 className="text-2xl font-semibold text-gray-800 mb-2">Investment</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-800">Personal Connection</h3>
            </div>
            <p className="text-gray-600">
        ...
        <div className="mb-8">
          ...
          <div className="bg-primary-2/5 p-6 rounded-lg border border-primary-2/20">
            <h4 className="font-semibold text-gray-800 mb-2">Market Performance Over Time</h4>
            <p className="text-gray-600">
