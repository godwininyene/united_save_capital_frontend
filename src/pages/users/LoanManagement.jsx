      ...
      <div className="flex flex-col">
        <div className="bg-white rounded-xl shadow-md overflow-hidden">
          ...
          <div className="p-6">
            {activeTab === "request" ? (
              <>
                <h1 className="text-xl font-semibold text-gray-800 mb-2">Request Loan</h1>
                ...
                {!preview ? (
                  ...
                  <div>
                    <h2 className="text-lg font-semibold text-gray-800 mb-4">Loan Request Summary</h2>
                    ...
                    <div className="bg-primary-2/5 p-4 rounded-lg border border-primary-2/20 mb-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                        <div>
                          ...
                          <p className="font-bold text-gray-800">${formData.amount}</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600">Duration</p>
                          <p className="font-bold text-gray-800">{formData.duration} months</p>
                        </div>
                      </div>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                        <div>
                          <p className="text-sm text-gray-600">Interest Rate</p>
                          <p className="font-bold text-gray-800">{formData.interestRate}%</p>
                        </div>
                        <div>
                          <p className="text-sm text-gray-600">Monthly Payment</p>
                          <p className="font-bold text-gray-800">${formData.monthlyPayment}</p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-4 mb-6">
                      <div>
                        <p className="text-sm text-gray-600">Repayment Plan</p>
                        <p className="font-medium text-gray-800 capitalize">{formData.repaymentPlan}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">Purpose</p>
                        <p className="font-medium text-gray-800">{formData.purpose || "N/A"}</p>
                      </div>
                    </div>
              ...
              <>
                <h1 className="text-xl font-semibold text-gray-800 mb-2">Loan History</h1>
                <p className="text-gray-600 mb-6 flex items-center gap-1">
                ...
                {isLoadingHistory ? (
                  ...
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-medium text-gray-700">No loan history found</h3>
                        ...
                        <div className="flex items-start justify-between">
                          <div>
                            <div className="flex items-center gap-2 mb-1">
                              <span className="font-semibold text-gray-800">${loan.amount.toLocaleString('en-US')}</span>
