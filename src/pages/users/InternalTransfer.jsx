    ...
    <div className="">
      <div className="flex flex-col">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-md">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-slate-100 mb-2">United Save Capital Secure Internal Transfer</h2>
          <p className="text-gray-600 dark:text-slate-400 mb-6 flex items-center gap-1">
            Transfer Funds to another United account
          </p>
          ...
          {confirmation ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-700 dark:text-slate-300 max-w-md mx-auto mb-6">
                Your Internal Transfer of £{formData.amount} has been successfully submitted.
              </p>
              ...
              <div className="space-y-5">
                ...
                <div className="bg-gray-50 dark:bg-slate-700 p-5 rounded-xl border border-gray-200 dark:border-slate-600">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                      <div>
                        <p className="text-sm text-gray-500 dark:text-slate-400">To Account</p>
                        <p className="font-medium text-gray-800 dark:text-slate-100">{formData.accountNumber}</p>
                      </div>
                    </div>
                  </div>
